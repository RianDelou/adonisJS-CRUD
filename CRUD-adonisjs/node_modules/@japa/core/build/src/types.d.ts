 ...
 */
export type TestHooksHandler<Context extends Record<any, any>> = HookHandler<TestHooksData<Context>[0], TestHooksData<Context>[1]>;
/**
 * The function that can be registered as a cleanup handler
 */
export type TestHooksCleanupHandler<Context extends Record<any, any>> = CleanupHandler<TestHooksData<Context>[1]>;
/**
 ...
 * methods on a group
 */
export type GroupHooksHandler<Context extends Record<any, any>> = HookHandler<GroupHooksData<Context>[0], GroupHooksData<Context>[1]>;
/**
 ...
 */
export type SuiteHooksHandler<Context extends Record<any, any>> = HookHandler<SuiteHooksData<Context>[0], SuiteHooksData<Context>[1]>;
/**
