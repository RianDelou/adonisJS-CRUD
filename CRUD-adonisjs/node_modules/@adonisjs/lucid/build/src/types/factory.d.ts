 ...
 * factory
 */
export type ExtractFactoryAttributes<Model extends LucidModel> = Partial<ModelAttributes<InstanceType<Model>>>;
/**
 * ------------------------------------------------------
 *  Callbacks
 * ------------------------------------------------------
 ...
 */
export type NewUpCallback<Model extends LucidModel, T extends FactoryModelContract<Model>> = (attributes: ExtractFactoryAttributes<Model>, ctx: FactoryContextContract, model: Model, builder: FactoryBuilderContract<Model, T>) => InstanceType<Model>;
/**
 * Function to merge attributes defined during runtime
 */
export type MergeCallback<Model extends LucidModel, T extends FactoryModelContract<Model>> = (row: InstanceType<Model>, attributes: ExtractFactoryAttributes<Model>, ctx: FactoryContextContract, builder: FactoryBuilderContract<Model, T>) => void;
/**
 * Callback to define a new model state
 */
export type StateCallback<Model extends LucidModel> = (row: InstanceType<Model>, ctx: FactoryContextContract, builder: FactoryBuilderContract<Model, FactoryModelContract<Model>>) => any | Promise<any>;
/**
 * ------------------------------------------------------
 *  Hooks
 * ------------------------------------------------------
 ...
 */
export type HooksHandler<Model extends LucidModel, T extends FactoryModelContract<Model>> = (builder: FactoryBuilderContract<Model, T>, row: InstanceType<Model>, ctx: FactoryContextContract) => void | Promise<void>;
/**
 * ------------------------------------------------------
 *  Runtime context
 * ------------------------------------------------------
 ...
 */
export type RelationCallback = (builder: FactoryBuilderContract<LucidModel, FactoryModelContract<LucidModel>>) => void;
/**
 ...
 */
export interface FactoryBuilderContract<Model extends LucidModel, FactoryModel extends FactoryModelContract<Model>> {
    /**
     ...
     */
    apply<K extends keyof FactoryModel['states']>(...states: K[]): FactoryBuilderContract<Model, FactoryModel>;
    /**
     ...
     */
    builder: FactoryModel['relations'][K] extends () => FactoryBuilderContract<any, any> ? ReturnType<FactoryModel['relations'][K]> & {
        parent: InstanceType<FactoryModel['model']>;
    } : never) => void): FactoryBuilderContract<Model, FactoryModel>;
    /**
     * Define pivot attributes when persisting a many to many
     * relationship. Results in a noop, when not called
     * for a many to many relationship
     */
    pivotAttributes(attributes: ModelObject | ModelObject[]): FactoryBuilderContract<Model, FactoryModel>;
    /**
     ...
     */
    merge(attributes: OneOrMany<ExtractFactoryAttributes<Model>>): FactoryBuilderContract<Model, FactoryModel>;
    /**
     ...
     * to the database
     */
    tap(callback: (row: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract, builder: FactoryBuilderContract<Model, FactoryModel>) => void): FactoryBuilderContract<Model, FactoryModel>;
    /**
 ...
 */
export interface FactoryBuilderQueryContract<Model extends LucidModel, FactoryModel extends FactoryModelContract<Model>> extends FactoryBuilderContract<Model, FactoryModel> {
    query(options?: ModelAdapterOptions, viaRelation?: FactoryRelationContract): FactoryBuilderContract<Model, FactoryModel>;
}
/**
 * ------------------------------------------------------
 *  Factory model
